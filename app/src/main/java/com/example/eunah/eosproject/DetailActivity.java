...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendToMessageBtn = findViewById(R.id.send_to_message_btn);
        ...
        if(checkDataList.get(position).isSoldOrNot() == true){
            sendToMessageBtn.setEnabled(false);
            sendToMessageBtn.setText(R.string.book_is_sold_out);
            sendToMessageBtn.setBackgroundColor(getResources().getColor(R.color.nextBtnColor));
        }
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id.send_to_message_btn:
                intent = new Intent(getApplicationContext(), ChatActivity.class);
                intent.putExtra("destinationUserId", bookDataList.get(position).getId());
                startActivity(intent);
        }
    }
}
