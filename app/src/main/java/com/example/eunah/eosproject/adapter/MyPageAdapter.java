...
import com.example.eunah.eosproject.MyPageDetailActivity;
...
public class MyPageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyPageAdapter(Context context, ArrayList<BookData> bookList, ArrayList<CheckData> checkList,
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (bookData != null) {
                ...
                Log.e(TAG, "onBindViewHolder: coverRef: "+ coverRef );
            ...
            if (bookData != null) {
                ...
                ((SoldOutViewHolder) holder).bookExpectationPrice2.setText(context.getResources().getString(R.string.price_won, bookData.getExtraExplanation()));
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            Intent intent = new Intent(view.getContext(), MyPageDetailActivity.class);
